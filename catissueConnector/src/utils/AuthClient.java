...
public class AuthClient {
    ...
    public AuthClient() {
    	this.properties = Utils.getConfig() ;
    }
    ...
    private class TestAuthenticator extends java.net.Authenticator {
        ...
        protected PasswordAuthentication getPasswordAuthentication() {
            return new PasswordAuthentication( AuthClient.this.properties.getProperty( Utils.USERID )
            		                         , AuthClient.this.properties.getProperty( Utils.PASSWORD ).toCharArray());
        }
